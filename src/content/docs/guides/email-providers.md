...
description: Comparez les six fournisseurs de courriel recommandés (Migadu, Mailbox.org, Hostpoint, Infomaniak, OVH Pro Mail, Mailfence) — où ils sont, ce qu'ils coûtent, quelles langues ils parlent, et comment ils gèrent les boîtes partagées.
---

Six fournisseurs de courriel matures, axés sur la confidentialité, couvrent les situations qu'on voit typiquement. Ils font tous bien les bases ; le tableau ci-dessous montre ce qui diffère réellement entre eux, pour que vous puissiez choisir selon les critères qui comptent pour vous.

## Ce que les six font bien
...
|                                            | Migadu                                                                | Mailbox.org                              | Hostpoint                       | Infomaniak                                       | OVH Pro Mail                   | Mailfence                       |
| ------------------------------------------ | --------------------------------------------------------------------- | ---------------------------------------- | ------------------------------- | ------------------------------------------------ | ------------------------------ | ------------------------------- |
| Où l'entreprise et les serveurs sont basés | Suisse                                                                | Allemagne                                | Suisse                          | Suisse                                           | France + région Canada         | Belgique                        |
| Tarification (CAD, approximatif) [^1]      | 12-40 $ / mois par domaine (boîtes illimitées dans une limite souple) | 40 $ de base + 1,60 $ / utilisateur / mois | 5,25 $ / utilisateur / mois     | 2,50 $ / utilisateur / mois (palier gratuit existe) | 7 $ / utilisateur / mois       | 5,60 $ / utilisateur / mois     |
| Interface française                        | non                                                                   | non                                      | oui                             | oui                                              | oui                            | oui                             |
| Interface anglaise                         | oui                                                                   | oui                                      | oui                             | oui                                              | non                            | oui                             |
| Boîte partagée                             | oui (identités partagées)                                             | non                                      | non                             | non                                              | non                            | non                             |
| Gestion des comptes en lot                 | oui                                                                   | partielle                                | partielle                       | oui                                              | oui                            | partielle                       |
