...
### Encrypted backups to client-owned storage (12 rehearsals)
...
Rehearsals: `mailserver_deploy`, `mailserver_round_trip`, `nextcloud_versions_retention_applied`
...
Rehearsals: `app_restore_round_trip`, `ce_restore`, `fi_d2_pg_dumpall_replay_constraint`, `fi_d3_postgres_oom_mid_restore`, `fi_d4_disk_full_mid_snapshot`, `fi_d5_disk_full_mid_converge`, `fi_d6_volume_uid_drift`, `fi_d7_restic_corrupt_pack`, `nc_s3_hot_recovery`, `nc_sync_wipe_restore`, `pitr_fuse_round_trip`, `recover_secrets_from_running_host`, `recovery_landing_page_bilingual_parity`, `restore_dr`, `restore_version_skew_abort`, `restore_version_skew_upgrade`, `s3_reconcile_orphan_cleanup`, `selective_restore_round_trip`
...
### Offsite immutable backup copy (7 rehearsals)
...
Rehearsals: `mirror_skips_on_bad_verify_hot`, `offsite_copy_unreachable_target`, `rclone_copy_preserves_pruned_packs`, `restic_check_subset_weekly`, `verify_hot_bootprobe_weekly`, `worm_object_lock_expiry_edge`, `worm_round_trip`
...
Written, not yet passing: `unlicensed_schedules_nothing`

### Staff and client account management (1 rehearsal)
...
Rehearsals: `identity_group_gates_access`
...
### Managed updates with automatic rollback (7 rehearsals)
...
Rehearsals: `catena_admin_self_update`, `control_plane_update_rollback`, `daily_chain_container_rollback`, `fi_u4_ovh_rate_limited`, `fi_u5_persistent_quarantine`, `fi_u6_full_rollback_state`, `infra_stack_update_rollback`
