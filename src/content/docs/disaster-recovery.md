...
|---|---|---|
| **I deleted a file by accident** (one user, one file/folder) | Try the app's own trash. If empty, contact your operator. | [I deleted something — how do I get it back?](/how-to-restore-one-app/) |
| **I lost my password or my 2FA** (just me) | Self-service password reset; for 2FA, contact your operator. | [I lost my password (or my 2FA)](/i-lost-my-password/) |
...
| **One app's data (you deleted something)** | Everything else | Try the app's own trash first; if empty, see [I deleted something — how do I get it back?](/how-to-restore-one-app/) |
...
| **S3 bucket accidentally deleted** | Your VPS and its data | Same — recreate the bucket and repoint backups. Some providers (Backblaze B2) keep deleted objects for a retention window, which might buy you time |
