...
- **Petite équipe, communication interne seulement.** [Nextcloud Talk](/fr/nextcloud-apps-vs-suite/) seul.
- **Discussion d'équipe et boîte de support client par web, courriel, réseaux sociaux et SMS.** [Rocket.Chat](/fr/apps/rocketchat-oidc/) pour la boîte ; Linphone pour le travail téléphonique sortant.
- **Messagerie chiffrée de bout en bout avec entrée téléphonique vers vos réunions.** [Element](/fr/apps/element/). Ajoutez Linphone à côté si votre équipe doit aussi passer des appels sortants.
