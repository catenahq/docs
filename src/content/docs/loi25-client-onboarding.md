...
- [ ] **Publish RPP coordinates** on your website (your privacy policy page, deployed by Catena, already has the slot -- see [where-is-my-data](/where-is-my-data/) for where it lives).
